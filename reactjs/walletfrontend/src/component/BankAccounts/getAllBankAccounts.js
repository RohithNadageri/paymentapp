...
import SearchByAccount from './searchAccountNo';
...
function ListOfBankAccount() {
    ...
    const getAllAccounts = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:8080/viewAllAccounts/${walletIdGet}`);
            ...
            <div class="card mb-7">
                ...
                <div id="wrapper" >
                    ...
                    <div class='searchBy'>
                        ...
                        <div class="ms-auto">
                        <SearchByAccount onSearch={handleSearchByAccount}/>
                        </div>
                    </div>
