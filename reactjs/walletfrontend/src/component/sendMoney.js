...
const SendMoney = () => {
    ...
    const addTransaction = (walletId, mobileNo, amount, desc) => {
        try{
        axios.put(`http://localhost:8080/addTransaction/${parseInt(6)}/${mobileNo}/${amount}/${desc}`, customConfig).then(function (response) {
    ...
    const transSubmit = e => {
        ...
        if(amount1 <= 0 ){
            ...
            console.log(walletId, mobileNo, amount,desc);
                    ...
                    <div class="row gx-lg-5 align-items-center">
                        <div class="col-lg-6 mb-5 mb-lg-0">
                            <h1 class=" display-3 fw-bold ls-tight text-light">
                                Simple And Easy Way To Tranfer<br />
                                        ...
                                        formSubmitted ? (<>
                                            ...
                                            <form id="registrationForm" onSubmit={transSubmit}>
                                                ...
                                                <div class="form-outline mb-3">
                                                    ...
                                                    <input type="text" id="form3Example3" class="form-control" name="mobileNo" placeholder='Mobile Number' value={mobileNo} onChange={changeTransHandler} required />
                                                ...
                                                <div class="form-outline mb-4">
                                                    ...
                                                    <input type="text" id="form3Example3" class="form-control" name="amount" placeholder='Amount' value={amount} onChange={changeTransHandler} required/>
                                                </div>

                                                <div class="form-outline mb-4">
                                                    <p class="form-label" for="form3Example3">Descprition</p>
                                                    <input type="text" id="form3Example3" class="form-control" name="desc" placeholder='Descprition' value={desc} onChange={changeTransHandler} required/>
